                        ...
                        <div class="container-fluid">
                           <div class="carousel-caption relative">
                              <div class="bluid text-overlay">
                                 ...
                                 <h1 class="bright-text" style="font-size: 45px;">How you doin</h1>
                        ...
                        <div class="container">
                           <div class="carousel-caption posi_in">
                              <div class="clientsl_text">
                                 ...
                                 <p> I can't express how much this EdTech page has helped me in my teaching journey. The lesson plans and classroom management tips have transformed my teaching methods. My students are more engaged, and their performance has improved significantly. The blog posts are also a goldmine of insights. Kudos to the team behind this page for making such a valuable resource available to educators like me!
                                 </p>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="container">
                           <div class="carousel-caption posi_in">
                              <div class="clientsl_text">
                                 ...
                                 <p>I stumbled upon this EdTech page recently, and I must say, I'm thoroughly impressed! The content here is incredibly informative and well-structured. As a student, I find the study tips and online resources section particularly helpful. Keep up the great work, and thank you for making learning more accessible!
                                 </p>
                              </div>
                           </div>
                        </div>
                        ...
                        <div class="container">
                           <div class="carousel-caption posi_in">
                              <div class="clientsl_text">
                                 ...
                                 <p>This EdTech page is a game-changer! The interactive learning tools and video tutorials have made understanding complex subjects so much easier for me. The user-friendly interface is a huge plus too. I appreciate the effort put into creating a platform that caters to both students and educators. It's definitely become my go-to resource for expanding my knowledge.</p>
                              </div>
                           </div>
                        </div>
                     </div>
                     ...
                     <div class="carousel-item active">
                        <div class="container-fluid">
                           <div class="carousel-caption relative">
                              <div class="bluid text-overlay">
                                 <div class="overlay"></div>
                                 <h1 class="bright-text" style="font-size: 45px;">Institute of Young Talents</h1>
